...
This module provides the access point to the \textit{Application Server} for the \textit{Web Server} and the \textit{Mobile Apps}.
It routes different users in the correct \textit{User Manger} module: Special User and Standard User; in order to manage guest users that visit a Run the system to be has to create Standard User that has the property to only have the possibility to watch a Run.
