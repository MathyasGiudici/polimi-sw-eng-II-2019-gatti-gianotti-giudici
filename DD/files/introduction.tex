...
This document follows the EEE Standard 1016:2009 \textit{System design - Software design descriptions} \cite{ieee-1016} and complies with the instructions contained in the project assignment document \cite{se-assignments}.\\
Furthermore, the constraints imposed in the \textit{Requirements Analysis and Specification Document} \cite{rasd} have been respected.
%At the end of the document the complete Bibliography is available.
...
\begin{itemize}
  ...
  \item[] \textbf{Section 3: User Interface Design}. This section contains the UX Diagrams of the system to be according to the mockups given in the RASD.
